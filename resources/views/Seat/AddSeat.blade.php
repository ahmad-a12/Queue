                                ...
                                <div class="row">
                                        <div class="row">
                                            <div class="mb-4 col-lg-6">
                                                ...
                                                <input id="number" class="form-control" placeholder="Seat Number" name="number" type="text">
                                            </div>
                                            @error('number')
                                            ...
                                            <div>
                                                <button class="btn btn-success mb-2"><i class="mdi mdi-plus me-2"></i> Add Seat</button>
                                            </div>
                                        </div>
